...
final class RequireParameterTypeSniffTest extends EcsTestCase
{
    public function test_reports_untyped_arrow_function_parameter(): void
    {
        $this->assertFixtureFailsWith(
            fixture: __DIR__ . '/../Fixtures/RequireParameterType/untyped_arrow_function.php',
            messages: [
                'Parameter $query must have a native type declaration.',
                'Prefer a precise type or explicit union; do not use mixed',
                'genuinely too numerous to list meaningfully.',
    ...
    {
        $this->assertFixtureFailsWith(
            fixture: __DIR__ . '/../Fixtures/RequireParameterType/untyped_parameter_forms.php',
            messages: [
